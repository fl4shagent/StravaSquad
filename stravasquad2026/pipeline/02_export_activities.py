#!/usr/bin/env python
"""
Export Strava activity summaries (last DAYS_BACK days) -> one CSV
-------------------------------------------------------------------
- Uses hard-coded credentials and token path (shared with the StravaProject pipeline).
- Fetches /athlete/activities?after=<DAYS_BACK days> for every athlete in friends_tokens.json
- Writes all_activities_clean.csv with:
...
OUTPUT_CSV    = Path(r"D:\BO\stravasquad2026\data\all_activities_clean.csv")
