...
OUTPUT_CSV = Path(r"D:\BO\stravasquad2026\data\athletes_profiles.csv")
STRAVA_API_URL = "https://www.strava.com/api/v3"
# ──────────────────────────

# Note: same as the StravaProject pipeline, this writes athletes_profiles.csv (raw).
# athletes_profiles_clean.csv (read by 06_load_to_stravadw.py) is produced by a manual
# cleanup step, not by this script - matches the existing gap in the StravaProject pipeline.
