...
files = [
    (r"D:\BO\strava_api_exports\best_clean_datetime.csv",              "RunBest",           False, "insert_only", "activity_id", ["start_index", "end_index"], ["id"]),
    (r"D:\BO\strava_api_exports\runstream.csv",                        "RunStream",         False, "insert_only", "activity_id", [], ["activity_id", "time_s"]),
    (r"D:\BO\strava_api_exports\segments_clean_datetime.csv",          "RunSegment",        True,  "insert_only", "activity_id", ["device_watts", "hidden", "visibility", "kom_rank"], ["id"]),
    (r"D:\BO\athletes_profiles_clean.csv",                             "Athlete",           True,  "upsert",      "athlete_id",  ["id"], ["athlete_id"]),
    (r"D:\BO\all_activities_clean_datetime.csv",                       "Activities",        False, "upsert",      "activity_id", [], ["activity_id"]),
    (r"D:\BO\strava_api_exports\runstream_segments_by_kilometers.csv", "RunSplitKilometer", False, "insert_only", "activity_id", [], ["activity_id", "segment_number"]),
]
